...
namespace ReplayFXSchedule.Web.Controllers
{
    public class APIV2Controller : Controller
    {
        ...
        // GET: Public
        public ActionResult Index(string category, int? convention_id)
        {
            string result;
            ...
            result = JsonConvert.SerializeObject(db.ReplayEvents.Where(e => (convention_id == null || e.Convention.Id == convention_id) && (String.IsNullOrEmpty(category) || e.ReplayEventTypes.Any(et => et.Name == category))).OrderBy(r => new { r.Date, r.StartTime }).ToList(), Formatting.None,
